...
<div id="main">	
  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu</span>
	...
	<div id="feedback">
	List of user loan application:
	<table id="t01" >
	<tr>
				<td><font face="arial" size="5"><b>Profile Id</b></font></td>
				<td><font face="arial" size="5"><b>Loan amt</b></font></td>
				<td><font face="arial" size="5"><b>Witness name</b></font></td>
				<td><font face="arial" size="5"><b>Annual income</b></font></td>
				<td><font face="arial" size="5"><b>Interest</b></font></td>
...

{
				 ...
				 $amt=$row1['loan_amt'];
				 $wn=$row1['witness_name'];
				 $in=$row1['annual_income'];
				 $int=$row1['interest'];
