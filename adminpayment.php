...
<div id="main">	
  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu</span>
	...
	<tr>
				...
				<td><font face="arial" size="5"><b>Payment no</b></font></td>
				<td><font face="arial" size="5"><b>Payment Mode</b></font></td>
				<td><font face="arial" size="5"><b>Payment bank</b></font></td>
				<td><font face="arial" size="5"><b>Payment status</b></font></td>
				<td><font face="arial" size="5"><b>Payment amount</b></font></td>
...

{
				 ...
				 $no=$row1['payment_no'];
				 $pm=$row1['payment_mode'];
				 $pb=$row1['payment_bank'];
				 $ps=$row1['payment_status'];
				 $amt=$row1['payment_amt'];
